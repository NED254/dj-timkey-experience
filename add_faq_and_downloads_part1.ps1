...
'@ | Set-Content -Path ".\api\downloads.js" -Encoding UTF8

# ---------- src/chapters/FAQ.jsx ----------
@'
...
'@ | Set-Content -Path ".\src\chapters\FAQ.jsx" -Encoding UTF8

Write-Host "Created api/downloads.js and src/chapters/FAQ.jsx" -ForegroundColor Green
Write-Host "Next: run the second script (Admin + Sound + App wiring)" -ForegroundColor Cyan
