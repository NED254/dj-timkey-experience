...
function MerchCard({ name, price, image, link }) {
  const whatsappHref =
    ...
    encodeURIComponent(`Hi Timkey, I'd like to order the ${name}${price ? ` (${price})` : ""}.`)
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        {price && <p className="text-blue-400 font-semibold mt-1">{price}</p>}
        ...
        <div className="flex flex-col gap-2 mt-4">
            ...
            className="text-center px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold rounded-sm transition-colors"
          >
            Order via WhatsApp
          </a>
          {link && (
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-center px-4 py-2.5 border border-zinc-700 hover:border-blue-500 text-white text-sm font-semibold rounded-sm transition-colors"
            >
              Buy Online
            </a>
          )}
