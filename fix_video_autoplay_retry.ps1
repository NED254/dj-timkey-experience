...
function PhoneCard({ label, src, poster, offset, onEnded, isSectionInView }) {
...
export default function Moments() {
  ...
  const isInView = useInView(sectionRef, { once: true, margin: '300px 0px' })
  ...
  return (
    <section ref={sectionRef} id="moments" className="relative bg-black py-24 md:py-36 overflow-hidden">
...
Write-Host "Moments.jsx and Sound.jsx updated with autoPlay + canplay-based retry." -ForegroundColor Green
